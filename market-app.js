/* Tenbagger Radar v2.65 loader. Core is preserved in market-app-core.js. */
(()=>{'use strict';const VERSION='2.65';
...
load('market-app-core.js?v='+VERSION).then(()=>load('market-brief.js?v='+VERSION)).then(()=>{stamp();setTimeout(stamp,300);setTimeout(stamp,1200)}).catch(e=>console.error('Tenbagger Radar module load failed',e));})();
