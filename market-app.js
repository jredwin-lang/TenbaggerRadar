/* Tenbagger Radar v2.66 loader. Core is preserved in market-app-core.js. */
(()=>{'use strict';const VERSION='2.66';
...
load('market-app-core.js?v='+VERSION).then(()=>load('market-brief.js?v='+VERSION+'&rev=3')).then(()=>load('market-research.js?v='+VERSION)).then(()=>{stamp();setTimeout(stamp,300);setTimeout(stamp,1200)}).catch(e=>console.error('Tenbagger Radar module load failed',e));})();
